      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
        ...
        <div className="lg:col-span-7 flex flex-col items-start z-10 w-full">
          ...
          <motion.h1
            ...
            className="text-3xl xs:text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-[1.05] text-white uppercase mb-4 sm:mb-5 w-full font-sans break-words"
          >
